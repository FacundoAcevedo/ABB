...
void pruebas_volumen_y_buscar(){
	...
	size_t largo=10;
	char* claves[] = { "4", "8", "0", "3", "1", "2",  "5", "7", "6", "9"};
	char* valores[] = {"4", "8", "0", "3", "1", "2",  "5", "7", "6", "9"};
...
//~ 
	...
	printf("Clave: %s", claves[0]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[0]));
	puts("");		
	print_test("El 8 pertenece todavia: ", abb_pertenece(arbol, "8"));
	print_test("El 0 pertenece todavia: ", abb_pertenece(arbol, "0"));
	print_test("El 3 pertenece todavia: ", abb_pertenece(arbol, "3"));
	print_test("El 1 pertenece todavia: ", abb_pertenece(arbol, "1"));
	print_test("El 2 pertenece todavia: ", abb_pertenece(arbol, "2"));
	print_test("El 5 pertenece todavia: ", abb_pertenece(arbol, "5"));
	print_test("El 7 pertenece todavia: ", abb_pertenece(arbol, "7"));
	print_test("El 6 pertenece todavia: ", abb_pertenece(arbol, "6"));
	print_test("El 9 pertenece todavia: ", abb_pertenece(arbol, "9"));
	print_test("Cantidad esta bien", abb_cantidad(arbol) == 9);
	
	printf("Clave: %s", claves[1]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[1]));
	puts("");		
	print_test("El 0 pertenece todavia: ", abb_pertenece(arbol, "0"));
	print_test("El 3 pertenece todavia: ", abb_pertenece(arbol, "3"));
	print_test("El 1 pertenece todavia: ", abb_pertenece(arbol, "1"));
	...
	print_test("El 6 pertenece todavia: ", abb_pertenece(arbol, "6"));
	print_test("El 9 pertenece todavia: ", abb_pertenece(arbol, "9"));	
	print_test("Cantidad esta bien", abb_cantidad(arbol) == 8);
	
	printf("Clave: %s", claves[2]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[2]));
	puts("");		
	print_test("El 3 pertenece todavia: ", abb_pertenece(arbol, "3"));
	print_test("El 1 pertenece todavia: ", abb_pertenece(arbol, "1"));
	print_test("El 2 pertenece todavia: ", abb_pertenece(arbol, "2"));
	...
	print_test("El 6 pertenece todavia: ", abb_pertenece(arbol, "6"));
	print_test("El 9 pertenece todavia: ", abb_pertenece(arbol, "9"));	
	print_test("Cantidad esta bien", abb_cantidad(arbol) == 7);

	printf("Clave: %s", claves[3]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[3]));
	puts("");		
	print_test("El 1 pertenece todavia: ", abb_pertenece(arbol, "1"));
	print_test("El 2 pertenece todavia: ", abb_pertenece(arbol, "2"));
	print_test("El 5 pertenece todavia: ", abb_pertenece(arbol, "5"));
	...
	printf("Clave: %s", claves[4]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[4]));
	puts("");		
	print_test("El 2 pertenece todavia: ", abb_pertenece(arbol, "2"));
	print_test("El 5 pertenece todavia: ", abb_pertenece(arbol, "5"));
	print_test("El 7 pertenece todavia: ", abb_pertenece(arbol, "7"));
	...
	printf("Clave: %s", claves[5]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[5]));
	puts("");		
	print_test("El 5 pertenece todavia: ", abb_pertenece(arbol, "5"));
	print_test("El 7 pertenece todavia: ", abb_pertenece(arbol, "7"));
	print_test("El 6 pertenece todavia: ", abb_pertenece(arbol, "6"));
	...
	printf("Clave: %s", claves[6]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[6]));
	puts("");		
	print_test("El 7 pertenece todavia: ", abb_pertenece(arbol, "7"));
	print_test("El 6 pertenece todavia: ", abb_pertenece(arbol, "6"));
	print_test("El 9 pertenece todavia: ", abb_pertenece(arbol, "9"));	
	...
	printf("Clave: %s", claves[7]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[7]));
	puts("");		
	print_test("El 6 pertenece todavia: ", abb_pertenece(arbol, "6"));
	print_test("El 9 pertenece todavia: ", abb_pertenece(arbol, "9"));	
	puts("");

	printf("Clave: %s", claves[8]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[8]));
	puts("");		
	print_test("El 9 pertenece todavia: ", abb_pertenece(arbol, "9"));	
	puts("");

	printf("Clave: %s", claves[9]);
	printf(" Valor borrado: %d", abb_borrar(arbol, claves[9]));
	puts("");		
